  ...
  return (
    <div className="min-h-screen bg-cream-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <h1 className="text-3xl font-bold text-sage-900 mb-6">Privacy Policy</h1>
        <div className="bg-white rounded-2xl border border-sage-100 p-8">
          <p className="text-bark-500">Questa pagina &egrave; in fase di redazione. La privacy policy completa sar&agrave; disponibile a breve.</p>
        </div>
      </div>
    </div>
  )
