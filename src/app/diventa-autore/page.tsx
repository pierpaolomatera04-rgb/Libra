...
import { Upload, Scissors, Calendar, Coins, Users, ArrowRight, CheckCircle, TrendingUp, PenTool } from 'lucide-react'
      ...
      <footer className="bg-sage-900 text-sage-200 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-xs text-sage-400 text-center md:text-right">
