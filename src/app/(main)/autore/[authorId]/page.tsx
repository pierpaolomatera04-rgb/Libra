          ...
          <div className="text-center sm:text-left mt-4">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-6 mt-4">
              <div className="text-center">
                ...
                <p className="text-xs font-medium text-bark-600 dark:text-[#aaaaaa]">Follower</p>
              </div>
              <div className="text-center">
                <p className="text-lg font-bold text-sage-900">{books.length}</p>
                <p className="text-xs font-medium text-bark-600 dark:text-[#aaaaaa]">Libri</p>
              </div>
              <div className="text-center">
                <p className="text-lg font-bold text-sage-900">{totalReads.toLocaleString()}</p>
                <p className="text-xs font-medium text-bark-600 dark:text-[#aaaaaa]">Pagine lette</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bg-sage-50 rounded-xl p-3 mb-5">
              ...
              <div className="flex justify-between text-xs text-bark-400 mt-1">
                ...
                <span className="font-semibold text-sage-700">&euro;{(tipAmount * 0.10 * 0.90).toFixed(2)}</span>
              </div>
